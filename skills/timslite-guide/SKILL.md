...
- **Installation**: Maven dependency `io.github.snower:timslite:0.1.6`
...
| `timestamp_units_per_seconds` | 0 | Dataset timestamp units per Unix second; 0 keeps legacy latest-written-timestamp retention, nonzero enables wall-clock retention |
